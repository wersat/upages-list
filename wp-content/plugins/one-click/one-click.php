            ...
            public static function get_imports()
            {
                return [
                    [
                        ...
                        'description' => __('Images will be downloaded from external source so please be patient. Required plugin <a href="https://wordpress.org/plugins/wordpress-importer/">WordPress Importer</a>.',
                            'one-click'),
                        'action'      => esc_url(wp_nonce_url(add_query_arg([
                            'one-click-step' => 'content',
                            'import'         => 'true'
                        ]), 'one_click_step_content_nonce', '_one_click_step_content_nonce')),
                    ],
                    [
                        'id'          => 'theme-options',
                        'file'        => ONE_CLICK_THEME_OPTIONS_FILE,
                        'title'       => __('Customizer Theme Options', 'one-click'),
                        'description' => __('Options imported from customizer. Plugin which was used to export options <a href="https://wordpress.org/plugins/customizer-export-import/">Customizer Export/Import</a>.',
                            'one-click'),
                        'action'      => esc_url(wp_nonce_url(add_query_arg('one-click-step', 'theme-options'),
                            'one_click_step_theme_options_nonce', '_one_click_step_theme_options_nonce')),
                    ],
                    [
                        'id'          => 'widgets-content',
                        'file'        => ONE_CLICK_WIDGETS_CONTENT_FILE,
                        'title'       => __('Widgets Content &amp; Options', 'one-click'),
                        'description' => __('Widget content and sidebar positions. Required plugin <a href="https://wordpress.org/plugins/widget-settings-importexport/">Widget Settings Importer/Exporter</a>.',
                            'one-click'),
                        'action'      => esc_url(wp_nonce_url(add_query_arg('one-click-step', 'widgets-content'),
                            'one_click_step_widgets_content_nonce', '_one_click_step_widgets_content_nonce')),
                    ],
                    [
                        'id'          => 'widget-logic',
                        'file'        => ONE_CLICK_WIDGET_LOGIC_FILE,
                        'title'       => __('Widget Logic', 'one-click'),
                        'description' => __('Widget Logic conditional tags import for better widget management. Required plugin <a href="https://wordpress.org/plugins/widget-logic/">Widget Logic</a>.',
                            'one-click'),
                        'action'      => esc_url(wp_nonce_url(add_query_arg('one-click-step', 'widget-logic'),
                            'one_click_step_widget_logic_nonce', '_one_click_step_widget_logic_nonce')),
                    ],
                    [
                        'id'          => 'custom-options',
                        'file'        => ONE_CLICK_CUSTOM_FILE,
                        'title'       => __('Custom Options', 'one-click'),
                        'description' => __('Custom options import functionality to fix same basic variables or proper menu locations.',
                            'one-click'),
                        'action'      => esc_url(wp_nonce_url(add_query_arg('one-click-step', 'custom-options'),
                            'one_click_step_custom_options_nonce', '_one_click_step_custom_options_nonce')),
                    ],
                ];
            }
