<?php
    ...
    class Inventor_Invoices_Logic
    {
        ...
        {
            add_action('pre_get_posts', [__CLASS__, 'restrict_user_on_archive']);
            add_action('wp', [__CLASS__, 'restrict_user_on_detail']);
            add_action('inventor_payment_processed', [__CLASS__, 'catch_payment'], 10, 9);
            add_filter('inventor_invoices_types', [__CLASS__, 'default_types'], 10, 1);
            add_filter('inventor_payment_proceed_gateway', [__CLASS__, 'proceed_payment_gateway'], 10, 2);
            add_filter('single_template', [__CLASS__, 'invoice_template']);
        }
        ...
        public static function catch_payment(
            ...
            update_post_meta($invoice_id, INVENTOR_INVOICE_PREFIX . 'supplier_registration_number',
            ...
            update_post_meta($invoice_id, INVENTOR_INVOICE_PREFIX . 'customer_registration_number',
