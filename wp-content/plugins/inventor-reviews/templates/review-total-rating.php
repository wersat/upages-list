<div class="inventor-reviews-total-rating">
  ...
  <?php
    echo sprintf(_n('<strong>%.2f / 5 </strong> from <a href="#listing-detail-section-reviews">%d review</a>',
      '<strong>%.2f / 5 </strong> from <a href="#listing-detail-section-reviews">%d reviews</a>',
      $reviews_count['approved'], 'inventor-reviews'), $total_rating, $reviews_count['approved']);
  ?>
</div>
