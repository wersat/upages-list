  ...
  <div id="listing-detail-section-reviews" class="listing-detail-section">
    <?php if (have_comments()) : ?>
      <h2 class="page-header review-title">
        <?php
          echo esc_attr(sprintf(_n('One review on &ldquo;%2$s&rdquo;', '%1$s reviews on &ldquo;%2$s&rdquo;',
            get_comments_number(), 'inventor-reviews'), number_format_i18n(get_comments_number()), get_the_title()));
        ?>
      </h2>
