...
<?php $facilities = get_post_meta(get_the_ID(),
  INVENTOR_LISTING_PREFIX . INVENTOR_PROPERTY_PREFIX . 'public_facilities', true); ?>
  ...
  <div class="listing-detail-section" id="listing-detail-section-property-public-facilities">
    ...
    <div class="listing-detail-property-public-facilities">
      <?php foreach ($facilities as $facility) : ?>
        <?php $key
          = esc_attr($facility[INVENTOR_LISTING_PREFIX . INVENTOR_PROPERTY_PREFIX . 'public_facilities_key']); ?>
        <?php $value
          = esc_attr($facility[INVENTOR_LISTING_PREFIX . INVENTOR_PROPERTY_PREFIX . 'public_facilities_value']); ?>
