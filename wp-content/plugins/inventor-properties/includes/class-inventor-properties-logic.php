...
class Inventor_Properties_Logic {
    ...
    public static function init() {
        add_action( 'inventor_after_listing_detail_attributes', array( __CLASS__, 'amenities' ) );
        add_action( 'inventor_after_listing_detail_attributes', array( __CLASS__, 'valuation' ) );
        add_action( 'inventor_after_listing_detail_attributes', array( __CLASS__, 'public_facilities' ) );
