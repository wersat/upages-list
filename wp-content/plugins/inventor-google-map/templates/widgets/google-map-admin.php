...
<p>
  ...
  <br>
  <small><?php echo __('Additional classes appended to body class (separated by comma)',
      'inventor-google-map'); ?></small>
</p>
<p>
  <label for="<?php echo esc_attr($this->get_field_id('button_text')); ?>">
    <?php echo __('Filter Button Text', 'inventor-google-map'); ?>
  </label>
  <input class="widefat"
...
<p>
  <label for="<?php echo esc_attr($this->get_field_id('filter')); ?>">
    ...
    <?php echo __('Filter', 'inventor-google-map'); ?>
  </label>
</p>
<p>
...
<h4><?php echo __('Input titles', 'inventor-google-map'); ?></h4>
<ul>
  <li>
    <label>
      <input type="radio"
      ...
      <?php echo __('Labels', 'inventor-google-map'); ?>
    </label>
  </li>
  <li>
    <label>
      <input type="radio"
        ...
        <?php echo ('placeholders' == $input_titles) ? 'checked="checked"' : ''; ?>
             id="<?php echo esc_attr($this->get_field_id('input_titles')); ?>"
             name="<?php echo esc_attr($this->get_field_name('input_titles')); ?>">
      <?php echo __('Placeholders', 'inventor-google-map'); ?>
    </label>
  </li>
</ul>
