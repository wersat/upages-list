...
<div class="widget-inner
 ...
 <?php echo (empty($instance['padding_bottom'])) ? '' : 'widget-pb'; ?>"
  ...
  <div class="map-wrapper">
    <div class="map-inner <?php if (Inventor_Google_Map_Widgets::is_closed($args['widget_id'],
      $instance)
    ) : ?>closed<?php endif; ?>">
      <div class="map-google">
        <div class="map-google-inner" style="height: <?php echo esc_attr($instance['height']); ?>">
          <div class="map" id="map"
               ...
               <?php if (is_post_type_archive() && ! empty($instance['intercept_post_type'])) : ?>data-post-type="<?php echo get_query_var('post_type'); ?>"<?php endif; ?>
               <?php if (is_singular()) : ?>data-post-id="<?php echo get_the_ID(); ?>"<?php endif; ?>
               <?php if (is_tax() && ! empty($instance['intercept_term'])) : global $wp_query; ?>data-term-taxonomy="<?php echo $wp_query->queried_object->taxonomy; ?>" data-term="<?php echo $wp_query->queried_object->term_id; ?>"<?php endif; ?>
        ...
        <?php if ( ! empty($instance['show_toggle'])) : ?>
          <div class="map-switch"><?php echo esc_attr__('Toggle Map', 'inventor-google-map'); ?></div>
        <?php endif; ?>
      </div>
                  ...
                  <div class="map-actions">
                    <?php if ( ! empty($instance['map_types']) && $instance['map_types'] == 'on') : ?>
                      <div class="map-actions-group">
                        <a id="map-control-type-roadmap">
                          <span><?php echo __('Roadmap', 'inventor-google-map'); ?></span>
                        </a>
                        <a id="map-control-type-terrain">
                          <span><?php echo __('Terrain', 'inventor-google-map'); ?></span>
                        </a>
                        <a id="map-control-type-satellite">
                          <span><?php echo __('Satellite', 'inventor-google-map'); ?></span>
                        </a>
                      </div>
                    <?php endif; ?>
