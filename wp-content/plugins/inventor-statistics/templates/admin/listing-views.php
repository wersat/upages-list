<div class="wrap">
  ...
  <?php if (empty($query_enabled)) : ?>
    <div class="notice warning">
      <p><?php echo __('Listing views logging is disabled. If you want to collect stats, plase enable under "Appearance - Customize".',
                  ...
                  <td>
                    <?php if (has_post_thumbnail($listing->key)) : ?>
                      <span class="table-small-image">
                                                <?php echo get_the_post_thumbnail($listing->key, [22, 22]); ?>
                                            </span>
                    <?php endif; ?>
                    <a href="<?php echo get_the_permalink($listing->key); ?>"><?php echo get_the_title($listing->key); ?>
                      <a>
                  </td>
                ...
                <tr>
                  <td>
                    ...
                    <a href="<?php echo get_term_link($term->term_taxonomy_id,
                      'locations'); ?>"><?php echo esc_attr($term->name); ?>
                      <a>
                  </td>
