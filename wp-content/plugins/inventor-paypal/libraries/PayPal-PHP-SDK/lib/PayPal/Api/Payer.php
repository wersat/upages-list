    ...
    class Payer extends PayPalModel
    {
        ...
        public function addFundingInstrument($fundingInstrument)
        {
            if ( ! $this->getFundingInstruments()) {
                ...
                return $this->setFundingInstruments(array_merge($this->getFundingInstruments(), [$fundingInstrument]));
            }
        }
        ...
        {
            return $this->setFundingInstruments(array_diff($this->getFundingInstruments(), [$fundingInstrument]));
        }
