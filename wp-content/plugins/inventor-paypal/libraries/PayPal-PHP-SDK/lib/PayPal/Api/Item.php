    ...
    class Item extends PayPalModel
    {
        ...
        public function addSupplementaryData($nameValuePair)
        {
            if ( ! $this->getSupplementaryData()) {
                ...
                return $this->setSupplementaryData(array_merge($this->getSupplementaryData(), [$nameValuePair]));
            }
        }
        ...
        {
            return $this->setSupplementaryData(array_diff($this->getSupplementaryData(), [$nameValuePair]));
        }
        ...
        public function addPostbackData($nameValuePair)
        {
            if ( ! $this->getPostbackData()) {
                ...
                return $this->setPostbackData(array_merge($this->getPostbackData(), [$nameValuePair]));
            }
        }
