    ...
    class Agreement extends PayPalResourceModel
    {
        ...
        public function addOverrideChargeModel($overrideChargeModel)
        {
            if ( ! $this->getOverrideChargeModels()) {
                ...
                return $this->setOverrideChargeModels(array_merge($this->getOverrideChargeModels(),
                        [$overrideChargeModel]));
            }
        }
        ...
        {
            return $this->setOverrideChargeModels(array_diff($this->getOverrideChargeModels(), [$overrideChargeModel]));
        }
