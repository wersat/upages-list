    ...
    class Payment extends PayPalResourceModel
    {
        ...
        public function addTransaction($transaction)
        {
            if ( ! $this->getTransactions()) {
                ...
                return $this->setTransactions(array_merge($this->getTransactions(), [$transaction]));
            }
        }
        ...
        public function addFailedTransaction($error)
        {
            if ( ! $this->getFailedTransactions()) {
                ...
                return $this->setFailedTransactions(array_merge($this->getFailedTransactions(), [$error]));
            }
        }
        ...
        {
            return $this->setFailedTransactions(array_diff($this->getFailedTransactions(), [$error]));
        }
        ...
        public function addBillingAgreementToken($billingAgreementToken)
        {
            if ( ! $this->getBillingAgreementTokens()) {
                ...
                return $this->setBillingAgreementTokens(array_merge($this->getBillingAgreementTokens(),
        ...
        {
            return $this->setBillingAgreementTokens(array_diff($this->getBillingAgreementTokens(),
                    [$billingAgreementToken]));
        }
