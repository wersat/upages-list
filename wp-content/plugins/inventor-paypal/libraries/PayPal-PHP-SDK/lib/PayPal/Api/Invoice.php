    ...
    class Invoice extends PayPalResourceModel
    {
        ...
        public function addBillingInfo($billingInfo)
        {
            if ( ! $this->getBillingInfo()) {
                ...
                return $this->setBillingInfo(array_merge($this->getBillingInfo(), [$billingInfo]));
            }
        }
        ...
        {
            return $this->setBillingInfo(array_diff($this->getBillingInfo(), [$billingInfo]));
        }
        ...
        public function addItem($invoiceItem)
        {
            if ( ! $this->getItems()) {
                ...
                return $this->setItems(array_merge($this->getItems(), [$invoiceItem]));
            }
        }
        ...
        {
            return $this->setItems(array_diff($this->getItems(), [$invoiceItem]));
        }
        ...
        public function addPaymentDetail($paymentDetail)
        {
            if ( ! $this->getPayments()) {
                ...
                return $this->setPayments(array_merge($this->getPayments(), [$paymentDetail]));
            }
        }
        ...
        {
            return $this->setPayments(array_diff($this->getPayments(), [$paymentDetail]));
        }
        ...
        public function addRefundDetail($refundDetail)
        {
            if ( ! $this->getRefunds()) {
                ...
                return $this->setRefunds(array_merge($this->getRefunds(), [$refundDetail]));
            }
        }
        ...
        {
            return $this->setRefunds(array_diff($this->getRefunds(), [$refundDetail]));
        }
