    ...
    class Plan extends PayPalResourceModel
    {
        ...
        public function addPaymentDefinition($paymentDefinition)
        {
            if ( ! $this->getPaymentDefinitions()) {
                ...
                return $this->setPaymentDefinitions(array_merge($this->getPaymentDefinitions(), [$paymentDefinition]));
            }
        }
        ...
        {
            return $this->setPaymentDefinitions(array_diff($this->getPaymentDefinitions(), [$paymentDefinition]));
        }
        ...
        public function addTerm($terms)
        {
            if ( ! $this->getTerms()) {
                ...
                return $this->setTerms(array_merge($this->getTerms(), [$terms]));
            }
        }
        ...
        {
            return $this->setTerms(array_diff($this->getTerms(), [$terms]));
        }
