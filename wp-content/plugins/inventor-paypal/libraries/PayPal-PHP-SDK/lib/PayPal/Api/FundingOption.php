    ...
    class FundingOption extends PayPalModel
    {
        ...
        public function addFundingSource($fundingSource)
        {
            if ( ! $this->getFundingSources()) {
                ...
                return $this->setFundingSources(array_merge($this->getFundingSources(), [$fundingSource]));
            }
        }
        ...
        {
            return $this->setFundingSources(array_diff($this->getFundingSources(), [$fundingSource]));
        }
