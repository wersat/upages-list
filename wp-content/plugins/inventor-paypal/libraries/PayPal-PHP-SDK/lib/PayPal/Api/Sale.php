    ...
    class Sale extends PayPalResourceModel
    {
        ...
        public function addPaymentHoldReason($string)
        {
            if ( ! $this->getPaymentHoldReasons()) {
                ...
                return $this->setPaymentHoldReasons(array_merge($this->getPaymentHoldReasons(), [$string]));
            }
        }
        ...
        {
            return $this->setPaymentHoldReasons(array_diff($this->getPaymentHoldReasons(), [$string]));
        }
