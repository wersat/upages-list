<?php
    ...
    class Framework_MockObject_Invocation_ObjectTest extends PHPUnit_Framework_TestCase
    {
        ...
        {
            new PHPUnit_Framework_MockObject_Invocation_Object('FooClass', 'FooMethod', ['an_argument'], new StdClass);
        }

        public function testAllowToGetClassNameSetInConstructor()
        {
            $invocation = new PHPUnit_Framework_MockObject_Invocation_Object('FooClass', 'FooMethod', ['an_argument'],
                new StdClass);
        ...
        public function testAllowToGetMethodParametersSetInConstructor()
        {
            ...
            $invocation = new PHPUnit_Framework_MockObject_Invocation_Object('FooClass', 'FooMethod',
                $expectedParameters, new StdClass);
        ...
        public function testConstructorAllowToSetFlagCloneObjectsInParameters()
        {
            ...
            $cloneObjects = true;
            $invocation = new PHPUnit_Framework_MockObject_Invocation_Object('FooClass', 'FooMethod', $parameters,
                new StdClass, $cloneObjects);
