...
<div class="form-group gateway-paypal-credit-card-first-name">
  ...
  <input type="text" class="form-control" name="first_name" id="first-name" value="<?php echo ! empty($_POST['first_name'])
    ? esc_attr($_POST['first_name']) : null; ?>">
</div>
<div class="form-group gateway-paypal-credit-card-last-name">
  <label for="last-name"><?php echo __('Last Name', 'inventor-paypal'); ?></label>
  <input type="text" class="form-control" name="last_name" id="last-name" value="<?php echo ! empty($_POST['last_name'])
    ? esc_attr($_POST['last_name']) : null; ?>">
</div>
<div class="form-group gateway-paypal-credit-card-number">
  ...
  <input type="text" class="form-control" name="card_number" id="card-number" value="<?php echo ! empty($_POST['card_number'])
    ? esc_attr($_POST['card_number']) : null; ?>">
</div>
<div class="form-group gateway-paypal-credit-card-cvv">
  <label for="cvv"><?php echo __('CVV', 'inventor-paypal'); ?></label>
  <input type="text" class="form-control" name="cvv" id="cvv" value="<?php echo ! empty($_POST['cvv'])
    ? esc_attr($_POST['cvv']) : null; ?>">
</div>
