  ...
  <div class="widget-content">
    ...
    <?php if ('image' == $variant): ?>
      ...
      <?php if ( ! empty($download_link)) : ?>
        <a href="<?php echo esc_attr($download_link); ?>" class="widget_coupon_detail_button"><?php echo esc_attr__('Print Coupon',
            'inventor-coupon'); ?></a>
      <?php endif; ?>
    <?php elseif ('code' == $variant) : ?>
      ...
      <?php if ( ! empty($code)) : ?>
        <a href="#" class="widget_coupon_detail_button widget_coupon_detail_button_get_the_code" data-code="<?php echo esc_attr($code); ?>">
          <?php echo esc_attr__('Get the Code', 'inventor-coupon'); ?>
        </a>
      <?php endif; ?>
      ...
      <?php if (is_user_logged_in()) : ?>
        ...
        <?php if (empty($user_code) && count($codes) < $count): ?>
          <a href="<?php echo admin_url('admin-ajax.php'); ?>"
            ...
            <?php echo esc_attr__('Generate Code', 'inventor-coupon'); ?>
          </a>
        <?php endif; ?>
    ...
    <?php $expiration = get_post_meta(get_the_ID(), INVENTOR_COUPON_PREFIX . 'end', true); ?>
