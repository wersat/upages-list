...
<div class="coupon-box">
  ...
  <div class="coupon-box-image"
    ...
    <div class="coupon-box-image-shadow"></div>
  ...
  <div class="coupon-box-content">
    ...
    <div class="coupon-box-content-sub">
      ...
      <span class="coupon-content-expiration">
          ...
          <?php echo esc_attr__('Expiration', 'inventor-coupons'); ?>: <?php echo date_i18n(get_option('date_format'),
            $expiration); ?><?php echo date_i18n(get_option('time_format'), $expiration); ?>
        <?php else : ?>
