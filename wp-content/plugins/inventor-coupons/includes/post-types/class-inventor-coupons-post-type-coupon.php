...
class Inventor_Coupons_Post_Type_Coupon {
	...
	public static function fields() {
		...
		Inventor_Post_Types::add_metabox( 'coupon', array( 'datetime_interval', 'Inventor_Coupons_Metaboxes::details', 'Inventor_Coupons_Metaboxes::codes', 'gallery', 'banner', 'contact', 'faq', 'flags', 'location', 'listing_category' ) );
	}
}
