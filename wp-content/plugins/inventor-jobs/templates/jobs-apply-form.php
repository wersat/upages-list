...
<?php else: ?>
  ...
  <h3><?php echo __(sprintf('You are going to apply as %s for job %s.', $current_user->display_name,
      get_the_title($job)), 'inventor-jobs'); ?></h3>
  ...
  <form method="post">
    ...
    <div class="button-wrapper">
      <button type="submit" class="btn btn-primary" name="jobs_apply_form"><?php echo __(sprintf('Apply for %s',
          get_the_title($job)), 'inventor-jobs'); ?></button>
    </div>
  </form>
<?php endif; ?>
