<?php
    ...
    class Inventor_Customizations_Currency
    {
        ...
        {
            $wp_customize->add_section('inventor_currencies[0]', [
                'title' => __('Inventor Currency', 'inventor'),
                'priority' => 1,
            ]);
            // Currency symbol
            $wp_customize->add_setting('inventor_currencies[0][symbol]', [
                'default' => '$',
                'capability' => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
            ]);
            $wp_customize->add_control('inventor_currencies[0][symbol]', [
                'label' => __('Currency Symbol', 'inventor'),
                'section' => 'inventor_currencies[0]',
                'settings' => 'inventor_currencies[0][symbol]',
            ]);
            // Currency code
            $wp_customize->add_setting('inventor_currencies[0][code]', [
                'default' => 'USD',
                'capability' => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
            ]);
            $wp_customize->add_control('inventor_currencies[0][code]', [
                'label' => __('Currency Code', 'inventor'),
                'section' => 'inventor_currencies[0]',
                'settings' => 'inventor_currencies[0][code]',
            ]);
            // Show after
            $wp_customize->add_setting('inventor_currencies[0][show_after]', [
                'default' => false,
                'capability' => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
            ]);
            $wp_customize->add_control('inventor_currencies[0][show_after]', [
                'type' => 'checkbox',
            ...
            // Decimal places
            $wp_customize->add_setting('inventor_currencies[0][money_decimals]', [
                'default' => 0,
                'capability' => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
            ]);
            $wp_customize->add_control('inventor_currencies[0][money_decimals]', [
            ...
            // Decimal Separator
            $wp_customize->add_setting('inventor_currencies[0][money_dec_point]', [
                'default' => '.',
                'capability' => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
            ]);
            $wp_customize->add_control('inventor_currencies[0][money_dec_point]', [
            ...
            // Thousands Separator
            $wp_customize->add_setting('inventor_currencies[0][money_thousands_separator]', [
                'default' => ',',
                'capability' => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
            ]);
            $wp_customize->add_control('inventor_currencies[0][money_thousands_separator]', [
