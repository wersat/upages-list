<?php
    ...
    class Inventor_Customizations_Wire_Transfer
    {
        ...
        {
            $wp_customize->add_section('inventor_wire_transfer', [
                'title' => __('Inventor Wire Transfer', 'inventor'),
                'priority' => 1,
            ]);
            // Account number
            $wp_customize->add_setting('inventor_wire_transfer_account_number', [
                'default' => null,
                'capability' => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
            ]);
            $wp_customize->add_control('inventor_wire_transfer_account_number', [
            ...
            // Bank code
            $wp_customize->add_setting('inventor_wire_transfer_swift', [
                'default' => null,
                'capability' => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
            ]);
            $wp_customize->add_control('inventor_wire_transfer_swift', [
            ...
            // Full name
            $wp_customize->add_setting('inventor_wire_transfer_full_name', [
                'default' => null,
                'capability' => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
            ]);
            $wp_customize->add_control('inventor_wire_transfer_full_name', [
            ...
            // Street
            $wp_customize->add_setting('inventor_wire_transfer_street', [
                'default' => null,
                'capability' => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
            ]);
            $wp_customize->add_control('inventor_wire_transfer_street', [
            ...
            // Postcode
            $wp_customize->add_setting('inventor_wire_transfer_postcode', [
                'default' => null,
                'capability' => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
            ]);
            $wp_customize->add_control('inventor_wire_transfer_postcode', [
            ...
            // City
            $wp_customize->add_setting('inventor_wire_transfer_city', [
                'default' => null,
                'capability' => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
            ]);
            $wp_customize->add_control('inventor_wire_transfer_city', [
            ...
            // Country
            $wp_customize->add_setting('inventor_wire_transfer_country', [
                'default' => null,
                'capability' => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
            ]);
            $wp_customize->add_control('inventor_wire_transfer_country', [
