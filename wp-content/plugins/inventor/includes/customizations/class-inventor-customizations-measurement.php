...
class Inventor_Customizations_Measurement
{
    ...
    public static function customizations($wp_customize)
    {
        ...
        $wp_customize->add_setting(
            'inventor_measurement_area_unit', [
            'default'           => 'sqft',
        ...
        // Distance unit
        $wp_customize->add_setting(
            'inventor_measurement_distance_unit', [
            'default'           => 'ft',
            'capability'        => 'edit_theme_options',
            'sanitize_callback' => 'sanitize_text_field',
            ]
        ...
        // Distance unit long
        $wp_customize->add_setting(
            'inventor_measurement_distance_unit_long', [
            'default'           => 'mi',
            'capability'        => 'edit_theme_options',
            'sanitize_callback' => 'sanitize_text_field',
            ]
        ...
        // Weight unit
        $wp_customize->add_setting(
            'inventor_measurement_weight_unit', [
            'default'           => 'lbs',
            'capability'        => 'edit_theme_options',
            'sanitize_callback' => 'sanitize_text_field',
            ]
