...
class Inventor_Customizations_General
{
    ...
    public static function customizations($wp_customize)
    {
        ...
        $wp_customize->add_control(
            new Inventor_Customize_Control_Checkbox_Multiple(
                $wp_customize,
                'inventor_general_post_types', [
                ...
                'choices'     => $types,
                'description' => __(
                    'After changing post types make sure that your resave permalinks in "Settings - Permalinks"',
                    'inventor'
                ),
                ]
            )
            ...
            $wp_customize->add_setting(
                'inventor_general_default_listing_sort', [
                'default'           => 'published',
                'capability'        => 'edit_theme_options',
            ...
            $wp_customize->add_setting(
                'inventor_general_default_listing_order', [
                'default'           => 'desc',
                'capability'        => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
                ]
            ...
            $wp_customize->add_setting(
                'inventor_log_in_after_registration', [
                'default'           => null,
                'capability'        => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
                ]
            ...
            $wp_customize->add_setting(
                'inventor_general_show_listing_archive_as_grid', [
                'default'           => false,
                'capability'        => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
                ]
            ...
            $wp_customize->add_setting(
                'inventor_general_google_browser_key', [
                'default'           => null,
                'capability'        => 'edit_theme_options',
                'sanitize_callback' => 'sanitize_text_field',
                ]
            ...
            $wp_customize->add_control(
                ...
                'description' => __(
                    'Browser API key. Read more <a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank">here</a>.',
                    'inventor'
                ),
                'section'     => 'inventor_general',
