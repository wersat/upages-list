<?php
    ...
    class Inventor_Scripts
    {
        ...
        public static function enqueue_frontend()
        {
            ...
            wp_register_script('masonry', plugins_url('/inventor-testimonials/assets/libraries/masonry.min.js'),
                ['jquery'], false, true);
        ...
        public static function enqueue_backend($hook)
        {
            ...
            wp_register_script('inventor-admin', plugins_url('/inventor/assets/js/inventor-admin.js'), ['jquery'],
                false, true);
