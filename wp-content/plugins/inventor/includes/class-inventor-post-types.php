...
class Inventor_Post_Types
{
    ...
    public static function init()
    {
        ...
        add_action('init', [__CLASS__, 'disable_post_types'], 12);
        add_filter('inventor_listing_type_supported', [__CLASS__, 'listing_type_supported'], 10, 2);
    }
    ...
    public static function includes()
    {
        ...
        include_once INVENTOR_POST_TYPES_DIR . '/class-inventor-post-type-report.php';
        include_once INVENTOR_POST_TYPES_DIR . '/class-inventor-post-type-user.php';
        //require_once INVENTOR_POST_TYPES_DIR . '/class-inventor-post-type-listing.php';
        include_once INVENTOR_POST_TYPES_DIR . '/class-inventor-post-type-business.php';
        include_once INVENTOR_POST_TYPES_DIR . '/class-inventor-post-type-car.php';
        include_once INVENTOR_POST_TYPES_DIR . '/class-inventor-post-type-dating.php';
        include_once INVENTOR_POST_TYPES_DIR . '/class-inventor-post-type-education.php';
        include_once INVENTOR_POST_TYPES_DIR . '/class-inventor-post-type-event.php';
        include_once INVENTOR_POST_TYPES_DIR . '/class-inventor-post-type-food.php';
        include_once INVENTOR_POST_TYPES_DIR . '/class-inventor-post-type-hotel.php';
        include_once INVENTOR_POST_TYPES_DIR . '/class-inventor-post-type-pet.php';
        include_once INVENTOR_POST_TYPES_DIR . '/class-inventor-post-type-shopping.php';
        include_once INVENTOR_POST_TYPES_DIR . '/class-inventor-post-type-travel.php';
    }
    ...
    public static function opening_hours_format_day($day, $tags = false)
    {
        ...
        if (! empty($custom_text)) {
            ...
            if ($tags) {
                $opening
                    = "<span class=\"from\">{$time_from}</span> <span class=\"separator\">-</span> <span class=\"to\">{$time_to}</span>";
            } else {
    ...
    public static function get_attributes($post_id = null)
    {
        ...
        foreach ($meta_boxes as $meta_box) {
            ...
            foreach ((array)$fields as $field) {
                ...
                // Select
                if (in_array($field['type'], ['select', 'radio', 'radio_inline'])) {
                ...
                if (in_array($field['type'], ['multicheck', 'multicheck_inline'])) {
                    $value = implode(', ', $value);
                ...
                if ('text_url' === $field['type']) {
                    $value = '<a href="' . $value . '">' . str_replace(
                        ['http://', 'https://'], '',
                        $value
                    ) . '</a>';
                }
    ...
    public static function render_listing_detail_sections()
    {
        ...
        foreach ($sections as $section => $section_title) {
            ...
            echo Inventor_Template_Loader::load(
                'listings/detail/section-' . $section_with_hyphens,
