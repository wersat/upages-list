...
class Inventor_Metaboxes {
	...
	public static function metabox_general( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_general', INVENTOR_LISTING_PREFIX  . 'title' ),
		) );
		...
		$cmb->add_field( array(
			...
			'type'              => 'wysiwyg',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_general', INVENTOR_LISTING_PREFIX  . 'description' ),
			'options'           => array(
				'textarea_rows' => 10,
				'media_buttons' => false,
			),
		...
		$cmb->add_field( array(
			...
			'type'              => 'file',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_general', INVENTOR_LISTING_PREFIX  . 'featured_image' ),
		) );
	}
	...
	public static function metabox_faq( $post_type ) {
		...
		$default = Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_faq', INVENTOR_LISTING_PREFIX . 'faq' );
	...
	public static function metabox_branding( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'type'              => 'text',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_branding', INVENTOR_LISTING_PREFIX . 'slogan' ),
		) );
		...
		$cmb->add_field( array(
			...
			'type'              => 'colorpicker',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_branding', INVENTOR_LISTING_PREFIX . 'brand_color' ),
		) );
		...
		$cmb->add_field( array(
			...
			'type'              => 'file',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_branding', INVENTOR_LISTING_PREFIX . 'logo' ),
            'skip'              => true,
		) );
	}
	...
	public static function metabox_banner( $post_type ) {
		...
		// Banner Type
		$default_type = Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_banner', INVENTOR_LISTING_PREFIX . 'banner' );
		$cmb->add_field( array(
			...
			'description'        => "<span class='banner-map'>" . __( 'To set map position go to section <strong>Location</strong>.', 'inventor' ) . "</span>
			                        <span class='banner-street-view'>" . __( 'To set Street View go to section <strong>Location</strong>. Do not forget to <strong>enable</strong> Street View.', 'inventor' ) . "</span>
			                        <span class='banner-inside-view'>" . __( 'To set Inside View go to section <strong>Location</strong>. Do not forget to <strong>enable</strong> Inside View.', 'inventor' ) . "</span>"
		) );
		...
		$cmb->add_field( array(
			...
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_banner', INVENTOR_LISTING_PREFIX . 'banner_image' ),
		...
		$cmb->add_field( array(
			...
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_banner', INVENTOR_LISTING_PREFIX . 'banner_video' ),
		...
		$cmb->add_field( array(
			...
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_banner', INVENTOR_LISTING_PREFIX . 'banner_video_loop' ),
			'row_classes'       => 'cmb-row-banner banner-video',
		) );

		// Google Map
		$default_zoom = Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_banner', INVENTOR_LISTING_PREFIX . 'zoom' );
		$cmb->add_field( array(
			'name'              => __( 'Zoom', 'inventor' ),
			'id'                => INVENTOR_LISTING_PREFIX  . 'banner_map_zoom',
			'type'              => 'text_small',
			'default'           => ! empty( $default_zoom ) ? $default_zoom : 12,
			'description'       => __( 'Minimum value of zoom is 0. Maximum value depends on location (12-25).', 'inventor' ),
        ...
        $default_map_type = Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_banner', INVENTOR_LISTING_PREFIX . 'map_type' );
        $cmb->add_field( array(
        ...
        $cmb->add_field( array(
            ...
            'type'              => 'checkbox',
            'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_banner', INVENTOR_LISTING_PREFIX . 'marker' ),
	...
	public static function metabox_gallery( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'type'              => 'file_list',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_gallery', INVENTOR_LISTING_PREFIX . 'gallery' )
		) );
	}
	...
	public static function metabox_color( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'taxonomy'          => 'colors',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_color', INVENTOR_LISTING_PREFIX  . 'color' ),
		) );
	}
	...
	public static function metabox_video( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'type'              => 'text_url',
			'description'       => __( 'For more information about embeding videos and video links support please read this <a href="http://codex.wordpress.org/Embeds">article</a>.', 'inventor' ),
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_video', INVENTOR_LISTING_PREFIX . 'video' )
		) );
	}
	...
	public static function metabox_opening_hours( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'default'       => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_opening_hours', INVENTOR_LISTING_PREFIX . 'opening_hours' ),
		) );
	}
	...
	public static function metabox_contact( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'type'              => 'text_email',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_contact', INVENTOR_LISTING_PREFIX . 'email' ),
		) );
		...
		$cmb->add_field( array(
			...
			'type'              => 'text',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_contact', INVENTOR_LISTING_PREFIX . 'phone' ),
		) );
		...
		$cmb->add_field( array(
			...
			'type'              => 'text_url',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_contact', INVENTOR_LISTING_PREFIX . 'website' ),
		) );
		...
		$cmb->add_field( array(
			...
			'type'              => 'textarea',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_contact', INVENTOR_LISTING_PREFIX . 'address' ),
		) );
	}
	...
	public static function metabox_social( $post_type ) {
		...
		$social_networks = array( // TODO: inventor filter
			'facebook' 		=> 'Facebook',
			'twitter' 		=> 'Twitter',
			'google' 		=> 'Google+',
			'instagram' 	=> 'Instagram',
		...
		foreach( $social_networks as $key => $title ) {
			$social->add_field( array(
				...
				'name' 		=> $title,
				'type' 		=> 'text_medium',
				'default' 	=> Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_social', INVENTOR_LISTING_PREFIX . $key ),
			) );
		}
	}
	...
	public static function metabox_price( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_price', INVENTOR_LISTING_PREFIX  . 'price' ),
		...
		$cmb->add_field( array(
			...
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_price', INVENTOR_LISTING_PREFIX  . 'price_prefix' ),
		) );
		...
		$cmb->add_field( array(
			...
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_price', INVENTOR_LISTING_PREFIX  . 'price_suffix' ),
		) );
		...
		$cmb->add_field( array(
			...
			'type'              => 'text_medium',
			'description'       => __( 'Any text instead of numeric price (for example "by agreement"). Prefix and Suffix will be ignored.', 'inventor' ),
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_price', INVENTOR_LISTING_PREFIX  . 'price_custom' ),
		) );
	}
	...
	public static function metabox_flags( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'type'              => 'checkbox',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_flags', INVENTOR_LISTING_PREFIX  . 'featured' ),
		) );
		...
		$cmb->add_field( array(
			...
			'type'              => 'checkbox',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_flags', INVENTOR_LISTING_PREFIX  . 'reduced' ),
		) );
	}
	...
	public static function metabox_date( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_date', INVENTOR_LISTING_PREFIX  . 'date' ),
		) );
	}
	...
	public static function metabox_time( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'type'              => 'text_time',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_time', INVENTOR_LISTING_PREFIX  . 'time' ),
		) );
	}
	...
	public static function metabox_date_interval( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'type'              => 'text_date_timestamp',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_date_interval', INVENTOR_LISTING_PREFIX  . 'date_from' ),
		) );
		...
		$cmb->add_field( array(
			...
			'type'              => 'text_date_timestamp',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_date_interval', INVENTOR_LISTING_PREFIX  . 'date_to' ),
		) );
	}
	...
	public static function metabox_datetime_interval( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_datetime_interval', INVENTOR_LISTING_PREFIX  . 'datetime_from' ),
		) );
		...
		$cmb->add_field( array(
			...
			'type'              => 'text_datetime_timestamp',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_datetime_interval', INVENTOR_LISTING_PREFIX  . 'datetime_to' ),
		) );
	}
	...
	public static function metabox_time_interval( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'type'              => 'text_time',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_time_interval', INVENTOR_LISTING_PREFIX  . 'time_from' ),
		) );
		...
		$cmb->add_field( array(
			...
			'type'              => 'text_time',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_time_interval', INVENTOR_LISTING_PREFIX  . 'time_to' ),
		) );
	}
	...
	public static function metabox_date_and_time_interval( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'id'                => INVENTOR_LISTING_PREFIX . 'date',
			'type'              => 'text_date_timestamp',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_date_and_time_interval', INVENTOR_LISTING_PREFIX  . 'date' ),
		) );
		...
		$cmb->add_field( array(
			...
			'id'                => INVENTOR_LISTING_PREFIX . 'time_from',
			'type'              => 'text_time',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_date_and_time_interval', INVENTOR_LISTING_PREFIX  . 'time_from' ),
		) );
		...
		$cmb->add_field( array(
			...
			'id'                => INVENTOR_LISTING_PREFIX . 'time_to',
			'type'              => 'text_time',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_date_and_time_interval', INVENTOR_LISTING_PREFIX  . 'time_to' ),
		) );
	}
	...
	public static function metabox_location( $post_type ) {
		...
		$cmb->add_field( array(
			...
			'split_values'      => true,
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_location', INVENTOR_LISTING_PREFIX  . 'map_location' ),
			'skip'              => true
		) );
	...
	//			'description'       => __( 'Enter encoded path. It can be constructed using <a href="https://developers.google.com/maps/documentation/utilities/polylineutility" target="_blank">Interactive Polyline Encoder Utility</a>.', 'inventor' ),
				'description'       => __( 'Enter encoded path. It can be constructed using <a href="https://google-developers.appspot.com/maps/documentation/utilities/polylineutility_6dfa1f29011ecf2cf389dba27e343637.frame?hl=en&redesign=true" target="_blank">Interactive Polyline Encoder Utility</a>.', 'inventor' ),
				'type'              => 'text',
				'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_location', INVENTOR_LISTING_PREFIX  . 'map_location_polygon' ),
				'skip'              => true
			) );
		}
		...
		if ( apply_filters( 'inventor_metabox_location_street_view_enabled', true, $post_type ) ) {
			...
			$cmb->add_field(array(
				...
				'default' => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_location', INVENTOR_LISTING_PREFIX . 'street_view' ),
				'skip' => 'true',
			));
			...
			$cmb->add_field(array(
				...
				'split_values' => true,
				'default' => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_location', INVENTOR_LISTING_PREFIX . 'street_view_location' ),
				'skip' => 'true',
			));
		}
		...
		if ( apply_filters( 'inventor_metabox_location_inside_view_enabled', true, $post_type ) ) {
			...
			$cmb->add_field(array(
				...
				'default' => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_location', INVENTOR_LISTING_PREFIX . 'inside_view' ),
				'skip' => 'true',
			));
			...
			$cmb->add_field(array(
				...
				'sanitization_cb' => 'street_view_sanitise',
				'split_values' => true,
				'default' => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_location', INVENTOR_LISTING_PREFIX . 'inside_view_location' ),
				'skip' => 'true',
			));
		}
		...
		$cmb->add_field( array(
			...
			'taxonomy'          => 'locations',
			'default'           => Inventor_Submission::get_submission_field_value( INVENTOR_LISTING_PREFIX . $post_type . '_location', INVENTOR_LISTING_PREFIX  . 'locations' ),
		) );
	}
}
