...
class Inventor_Metaboxes
{
    ...
    public static function metabox_faq($post_type)
    {
        ...
        $default = Inventor_Submission::get_submission_field_value(
            INVENTOR_LISTING_PREFIX . $post_type . '_faq',
    ...
    public static function metabox_branding($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'type'    => 'text',
            'default' => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_branding',
    ...
    public static function metabox_banner($post_type)
    {
        ...
        // Banner Type
        $default_type
            = Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_banner',
        ...
        $cmb->add_field(
            ...
            'description' => "<span class='banner-map'>" . __(
                'To set map position go to section <strong>Location</strong>.',
                'inventor'
            ) . "</span><span class='banner-street-view'>" . __(
                'To set Street View go to section <strong>Location</strong>. Do not forget to <strong>enable</strong> Street View.',
                'inventor'
            ) . "</span><span class='banner-inside-view'>" . __(
                'To set Inside View go to section <strong>Location</strong>. Do not forget to <strong>enable</strong> Inside View.',
                'inventor'
            ) . '</span>'
            ]
        );
        ...
        $cmb->add_field(
            ...
            'description' => __(
                'Minimum value of zoom is 0. Maximum value depends on location (12-25).',
                'inventor'
            ),
    ...
    public static function metabox_gallery($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'type'    => 'file_list',
            'default' => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_gallery',
    ...
    public static function metabox_color($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'taxonomy' => 'colors',
            'default'  => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_color',
    ...
    public static function metabox_video($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'type'        => 'text_url',
            'description' => __(
                'For more information about embeding videos and video links support please read this <a href="http://codex.wordpress.org/Embeds">article</a>.',
                'inventor'
            ),
            'default'     => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_video',
    ...
    public static function metabox_listing_category($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'default'  => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_listing_category',
    ...
    public static function metabox_opening_hours($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'default'     => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_opening_hours',
    ...
    public static function metabox_contact($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'type'    => 'text_email',
            'default' => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_contact',
    ...
    public static function metabox_social($post_type)
    {
        ...
        foreach ($social_networks as $key => $title) {
            $social->add_field(
                ...
                'type'    => 'text_medium',
                'default' => Inventor_Submission::get_submission_field_value(
                    INVENTOR_LISTING_PREFIX . $post_type . '_social',
    ...
    public static function metabox_price($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'default'         => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_price',
        ...
        $cmb->add_field(
            ...
            'type'        => 'text_medium',
            'description' => __(
                'Any text instead of numeric price (for example "by agreement"). Prefix and Suffix will be ignored.',
                'inventor'
            ),
            'default'     => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_price',
    ...
    public static function metabox_flags($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'type'    => 'checkbox',
            'default' => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_flags',
    ...
    public static function metabox_date($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'default' => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_date',
    ...
    public static function metabox_time($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'type'    => 'text_time',
            'default' => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_time',
    ...
    public static function metabox_date_interval($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'type'    => 'text_date_timestamp',
            'default' => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_date_interval',
    ...
    public static function metabox_datetime_interval($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'default' => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_datetime_interval',
    ...
    public static function metabox_time_interval($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'type'    => 'text_time',
            'default' => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_time_interval',
    ...
    public static function metabox_date_and_time_interval($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'type'    => 'text_date_timestamp',
            'default' => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_date_and_time_interval',
                INVENTOR_LISTING_PREFIX . 'date'
            )
            ]
        );
    ...
    public static function metabox_location($post_type)
    {
        ...
        $cmb->add_field(
            ...
            'split_values'    => true,
            'default'         => Inventor_Submission::get_submission_field_value(
                INVENTOR_LISTING_PREFIX . $post_type . '_location',
        ...
        if (apply_filters('inventor_metabox_location_polygon_enabled', true, $post_type)) {
            ...
            $cmb->add_field(
                ...
                'description' => __(
                    'Enter encoded path. It can be constructed using <a href="https://google-developers.appspot.com/maps/documentation/utilities/polylineutility_6dfa1f29011ecf2cf389dba27e343637.frame?hl=en&redesign=true" target="_blank">Interactive Polyline Encoder Utility</a>.',
                    'inventor'
                ),
                'type'        => 'text',
                'default'     => Inventor_Submission::get_submission_field_value(
