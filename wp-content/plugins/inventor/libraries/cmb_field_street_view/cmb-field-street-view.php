<?php
    ...
    class CMB2_Field_Google_Street_View
    {
        ...
        {
            add_filter('cmb2_render_street_view', [$this, 'render_street_view'], 10, 5);
            add_filter('cmb2_sanitize_street_view', [$this, 'sanitize_street_view'], 10, 4);
         ...
         * Render field.
         */
        public function render_street_view(
            $field,
            $field_escaped_value,
            $field_object_id,
            $field_object_type,
        ...
        {
            wp_enqueue_script('cmb-google-street-view', plugins_url('js/script.js', __FILE__), ['jquery']);
