  ...
  <div class="form-group form-group-distance">
    ...
    <div class="input-group">
      <input type="number" name="filter-distance"
             min="0"
             <?php if ('placeholders' == $input_titles) : ?>placeholder="<?php echo __('Distance',
               'inventor'); ?>"<?php endif; ?>
    ...
    <input type="hidden" name="filter-distance-latitude" value="<?php if (!empty($instance['latitude'])) : ?><?php echo esc_attr($instance['latitude']); ?><?php endif; ?>">
    <input type="hidden" name="filter-distance-longitude" value="<?php if (!empty($instance['longitude'])) : ?><?php echo esc_attr($instance['longitude']); ?><?php endif; ?>">
  </div>
<?php endif; ?>
