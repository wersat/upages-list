...
<div class="widget widget-advanced-options">
    <div class="widget-top" style="background-color: transparent;">
        <div class="widget-title" style="cursor: pointer;">
            <h4 style="color: #333"><span class="dashicons dashicons-admin-generic" style="margin: -3px 0px -4px -2px; font-size: 18px;"></span> <?php echo __( 'Advanced Options', 'inventor' ); ?></h4>
        </div>
    </div>
