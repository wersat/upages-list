...
<?php endif; ?>
	<form method="post" action="<?php the_permalink(); ?>">
		...
		<?php if ( ! empty( $instance['show_phone'] ) ) : ?>
			<div class="form-group">
				<input class="form-control" name="phone" type="text" placeholder="<?php echo __( 'Phone', 'inventor' ); ?>" required="required">
			</div><!-- /.form-group -->
		<?php endif; ?>

		<?php if ( ! empty( $instance['show_subject'] ) ) : ?>
			<div class="form-group">
				<input class="form-control" name="subject" type="text" placeholder="<?php echo __( 'Subject', 'inventor' ); ?>" required="required">
			</div><!-- /.form-group -->
		<?php endif; ?>
		...
		<?php if ( ! empty( $instance['show_message'] ) ) : ?>
			<div class="form-group">
				<textarea class="form-control" name="message" required="required" placeholder="<?php echo __( 'Message', 'inventor' ); ?>" rows="4"></textarea>
			</div><!-- /.form-group -->
		<?php endif; ?>
