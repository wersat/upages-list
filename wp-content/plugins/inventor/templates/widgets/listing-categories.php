...
<div class="widget-inner
    ...
    <ul class="nav nav-tabs listing-categories-tabs" role="tablist">
        ...
        <li class="nav-item <?php if ($index === 0) : ?>active<?php 
       endif; ?>">
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane <?php if ($index === 0) : ?>active<?php 
       endif; ?>" id="listing-categories-<?php echo esc_attr($term->term_id); ?>">
          <ul>
