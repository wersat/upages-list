<div class="listing-box">
  <?php if (has_post_thumbnail()) : ?>
    ...
    <div class="listing-box-image" style="background-image: url('<?php echo esc_attr($image[0]); ?>');">
      <a href="<?php the_permalink(); ?>"></a>
    </div>
  <?php else : ?>
    <div class="listing-box-image" style="background-image: url('<?php echo plugins_url('inventor'); ?>/assets/img/default-item.png');">
      <a href="<?php the_permalink(); ?>"></a>
    </div>
  <?php endif; ?>
