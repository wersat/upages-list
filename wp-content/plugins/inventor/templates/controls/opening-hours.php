    ...
    <?php foreach ($days as $key => $display): ?>
      <tr>
        ...
        <td>
          ...
          <input type="hidden" name="listing_opening_hours[<?php echo $index; ?>][listing_day]" id="listing_opening_hours_<?php echo $index; ?>_listing_day" value="<?php echo $key; ?>"><?php echo $display; ?>
        </td>
        <td>
          <label for="listing_opening_hours_<?php echo $index; ?>_listing_time_from"></label>
          <input type="text" class="cmb2-timepicker text-time" name="listing_opening_hours[<?php echo $index; ?>][listing_time_from]" id="listing_opening_hours_<?php echo $index; ?>_listing_time_from" value="<?php echo $time_from; ?>">
        </td>
        <td>
          <label for="listing_opening_hours_<?php echo $index; ?>_listing_time_to"></label>
          <input type="text" class="cmb2-timepicker text-time" name="listing_opening_hours[<?php echo $index; ?>][listing_time_to]" id="listing_opening_hours_<?php echo $index; ?>_listing_time_to" value="<?php echo $time_to; ?>">
        </td>
        <td>
          <label for="listing_opening_hours_<?php echo $index; ?>_listing_time_custom"></label>
