		...
		<form class="payment-form" method="post" action="?">
							...
							<div class="form-group terms-conditions-input">
								<div class="checkbox">
									<label for="terms-and-conditions">
										...
										<?php echo sprintf( __( 'I agree with <a href="%s">terms & conditions</a>', 'inventor' ), get_permalink( $terms ) ); ?>
									</label>
								</div><!-- /.checkbox -->
			...
			<?php if ( ! empty( $submission_page_id ) ) : ?>
				<p class="payment-back">
					<?php echo __( 'Back to', 'inventor' ); ?>: <a href="<?php echo get_permalink( $submission_page_id ); ?>">
