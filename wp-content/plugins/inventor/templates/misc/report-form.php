...
<?php else: ?>
  ...
  <form method="post" action="<?php echo get_the_permalink($listing) ?>">
    ...
    <div class="form-group">
      ...
      <div class="radio">
        <label for="nudity">
          <input type="radio" name="reason" id="nudity" required value="<?php echo __('It is nudity or pornography',
            'inventor'); ?>">
      ...
      <div class="radio">
        <label for="humiliation">
          <input type="radio" name="reason" id="humiliation" required value="<?php echo __('It humiliates somebody',
            'inventor'); ?>">
      ...
      <div class="radio">
        <label for="inappropriate">
          <input type="radio" name="reason" id="inappropriate" required value="<?php echo __('It is inappropriate',
            'inventor'); ?>">
      ...
      <div class="radio">
        <label for="attack">
          <input type="radio" name="reason" id="attack" required value="<?php echo __('It insults or attacks someone based on their religion, ethnicity or sexual orientation',
            'inventor'); ?>">
          <?php echo __('It insults or attacks someone based on their religion, ethnicity or sexual orientation',
            'inventor'); ?>
        </label>
      </div>
      <div class="radio">
        <label for="violence">
          <input type="radio" name="reason" id="violence" required value="<?php echo __('It advocates violence or harm to a person or animal',
            'inventor'); ?>">
      ...
      <div class="radio">
        <label for="harming">
          <input type="radio" name="reason" id="harming" required value="<?php echo __('It displays someone harming themself or planning to harm themself',
            'inventor'); ?>">
      ...
      <div class="radio">
        <label for="drugs">
          <input type="radio" name="reason" id="drugs" required value="<?php echo __('It describes buying or selling drugs, guns or regulated products',
            'inventor'); ?>">
      ...
      <div class="radio">
        <label for="unauthorized">
          <input type="radio" name="reason" id="unauthorized" required value="<?php echo __('It is an unauthorized use of my intellectual property',
            'inventor'); ?>">
      ...
      <div class="radio">
        <label for="something_else">
          <input type="radio" name="reason" id="something_else" required value="<?php echo __('Something else',
            'inventor'); ?>">
    ...
    <div class="form-group">
      <textarea class="form-control" name="message" placeholder="<?php echo __('Other reason or additional information',
    ...
    <div class="button-wrapper">
      <button type="submit" class="btn btn-primary" name="report_form"><?php echo __('Submit to review',
          'inventor'); ?></button>
    </div>
  </form>
<?php endif; ?>
