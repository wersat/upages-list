...
<?php else: ?>
  ...
  <form method="post" action="<?php echo get_the_permalink($listing) ?>">
    ...
    <div class="form-group">
      ...
      <div class="radio">
        <label for="nudity">
          <input type="radio" name="reason" id="nudity" required value="<?php echo __(
      ...
      <div class="radio">
        <label for="humiliation">
          <input type="radio" name="reason" id="humiliation" required value="<?php echo __(
      ...
      <div class="radio">
        <label for="inappropriate">
          <input type="radio" name="reason" id="inappropriate" required value="<?php echo __(
              'It is inappropriate',
              'inventor'
          ); ?>">
      ...
      <div class="radio">
        <label for="attack">
          <input type="radio" name="reason" id="attack" required value="<?php echo __(
      ...
      <div class="radio">
        <label for="violence">
          <input type="radio" name="reason" id="violence" required value="<?php echo __(
      ...
      <div class="radio">
        <label for="harming">
          <input type="radio" name="reason" id="harming" required value="<?php echo __(
      ...
      <div class="radio">
        <label for="drugs">
          <input type="radio" name="reason" id="drugs" required value="<?php echo __(
      ...
      <div class="radio">
        <label for="unauthorized">
          <input type="radio" name="reason" id="unauthorized" required value="<?php echo __(
      ...
      <div class="radio">
        <label for="something_else">
          <input type="radio" name="reason" id="something_else" required value="<?php echo __(
              'Something else',
              'inventor'
          ); ?>">
    ...
    <div class="form-group">
      <textarea class="form-control" name="message" placeholder="<?php echo __(
          'Other reason or additional information',
          'inventor'
      ); ?>" rows="4"></textarea>
    </div><!-- /.form-group -->
    ...
    <div class="row">
      <div class="form-group col-md-6">
        <input class="form-control" name="name" type="text" placeholder="<?php echo __(
            'Name',
            'inventor'
        ); ?>" required="required">
      </div><!-- /.form-group -->
      <div class="form-group col-md-6">
        <input class="form-control" name="email" type="email" placeholder="<?php echo __(
            'E-mail',
            'inventor'
        ); ?>" required="required">
      </div><!-- /.form-group -->
    ...
    <div class="button-wrapper">
      <button type="submit" class="btn btn-primary" name="report_form"><?php echo __(
          'Submit to review',
          'inventor'
      ); ?></button>
    </div><!-- /.button-wrapper -->
