...
<?php if (! empty($create_page_id)) : ?>
    ...
    <a href="<?php echo get_permalink($create_page_id); ?>" class="listing-create"><?php echo __(
        'Create listing',
        'inventor'
    ); ?></a>
    <?php endif; ?>
      ...
      <div class="listing-system">
        <div class="listing-system-row">
          ...
          <div class="listing-system-row-image">
            <a href="<?php the_permalink(); ?>" style="background-image: url('<?php if (has_post_thumbnail()) : ?><?php echo esc_attr($image[0]); ?><?php else : ?><?php echo plugins_url('inventor'); ?>/assets/img/default-item.png<?php 
           endif; ?>')">
