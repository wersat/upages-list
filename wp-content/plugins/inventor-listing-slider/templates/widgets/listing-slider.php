...
<?php if (have_posts()) : ?>
  <div class="listings-slider-list owl-carousel owl-theme <?php if ( ! empty($instance['fullscreen'])) : ?>listings-slider-fullscreen<?php endif; ?>" style="height: <?php echo ! empty($instance['height'])
    ? $instance['height'] : '500px'; ?>;">
    <?php $index = 0; ?>
    <?php while (have_posts()) : the_post(); ?>
      ...
      <div class="listings-slider-item" data-index="<?php echo esc_attr($index); ?>">
        <div class="listings-slider-item-image" style="height: <?php echo ! empty($instance['height'])
          ? $instance['height'] : '500px'; ?>; background-image: url('<?php echo esc_attr($image); ?>');">
        </div>
  ...
  <div class="listings-slider-dots">
    ...
    <?php while (have_posts()) : the_post(); ?>
      ...
      <div class="listings-slider-dot <?php if (0 == $index) : ?>active<?php endif; ?>" data-index="<?php echo esc_attr($index); ?>" data-background-image="<?php echo $image_thumbnail_src[0]; ?>" alt='<?php the_title(); ?>'></div>
      <?php ++$index; ?>
    <?php endwhile; ?>
  </div>
