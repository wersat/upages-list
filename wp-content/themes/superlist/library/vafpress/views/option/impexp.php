<div class="vp-field vp-textarea"
     data-vp-type="vp-textarea">
  <div class="label">
    <label>
      <?php _e('Import', 'upages') ?>
    </label>
    <div class="description">
      <p><?php _e('Import Options', 'upages') ?></p>
    </div>
  </div>
  <div class="field">
    <div class="input">
...
<div class="vp-field vp-textarea"
  ...
  <div class="field">
    <div class="input">
            <textarea id="vp-js-export_text"
                      onclick="this.focus();this.select()"
                      readonly="readonly"></textarea>
      <div class="buttons">
        <input id="vp-js-export"
               class="vp-button button"
               type="button"
