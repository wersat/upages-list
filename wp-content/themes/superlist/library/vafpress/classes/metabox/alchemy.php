...
if (!class_exists('WPAlchemy_MetaBox')) {
    include_once VP_FileSystem::instance()
...
class VP_MetaBox_Alchemy extends WPAlchemy_MetaBox
{
    ...
    public function _render_repeating_group($group)
    {
        ...
        foreach ($group['groups'] as $g) {
            ...
            $html .= '<div class="vp-wpa-group-heading"><a href="#" class="vp-wpa-group-title">' . $icon . $group['title'] . '</a><a href="#" class="dodelete vp-wpa-group-remove" title="' . __(
                'Remove',
                'upages'
            ) . '"><i class="fa fa-times"></i> ' . __('Remove', 'upages') . '</a></div>';
        ...
        $html .= '<a href="#" class="button button-large docopy-' . $name . '">' . __(
            'Add More',
            'upages'
        ) . '' . $group['title'] . '</a>';
        $html .= '</div>';
