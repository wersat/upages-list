...
class VP_WP_Loader
{
    ...
    {
        $this->_dependencies = apply_filters(
            'vp_dependencies_array', VP_Util_Config::instance()
            ->load('dependencies')
        );
        $this->_types        = [
            'option'             => [],
    ...
    {
        $messages        = VP_Util_Config::instance()
                                         ->load('messages');
        $localize        = [
            ...
            // validatable data
            'alphabet_validatable'     => apply_filters('vp_alphabet_validatable', ['vp-textbox', 'vp-textarea']),
            'alphanumeric_validatable' => apply_filters(
                'vp_alphanumeric_validatable',
                ['vp-textbox', 'vp-textarea']
            ),
            'numeric_validatable'      => apply_filters('vp_numeric_validatable', ['vp-textbox', 'vp-textarea']),
            'email_validatable'        => apply_filters('vp_email_validatable', ['vp-textbox', 'vp-textarea']),
            'url_validatable'          => apply_filters('vp_url_validatable', ['vp-textbox', 'vp-textarea']),
            'maxlength_validatable'    => apply_filters(
                'vp_maxlength_validatable',
                ['vp-toggle', 'vp-radiobutton', 'vp-radioimage', 'vp-select']
            ),
            'minlength_validatable'    => apply_filters(
                'vp_minlength_validatable',
                ['vp-toggle', 'vp-radiobutton', 'vp-radioimage', 'vp-select']
            ),
        ];
