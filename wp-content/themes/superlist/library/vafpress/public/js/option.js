;(function($) {
    ...
    $('.vp-menu-goto').each(
        function(i) {
            ...
            $panel.children('.vp-section').each(
                function(i) {
                    var $section = $(this);
                ...
                ajaxurl, data, function(response) {
                    ...
                    setTimeout(
                        function() {
                            ...
                            $save_status.stop(true, true).fadeOut(
                                1000, function() {
