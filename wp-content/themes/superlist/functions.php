 ...
 * Widgets
 */
require_once get_template_directory() . '/widgets/widget-boxes.php';
...
function superlist_enqueue_files() {
	...
	wp_register_style( 'font-awesome', get_template_directory_uri() . '/assets/libraries/font-awesome/css/font-awesome.min.css' );
	wp_enqueue_style( 'font-awesome' );

	wp_register_style( 'superlist-font', get_template_directory_uri() . '/assets/libraries/superlist-font/style.css' );
	...
	wp_register_style( 'owl-carousel', get_template_directory_uri() . '/assets/libraries/owl.carousel/owl.carousel.css' );
	wp_enqueue_style( 'owl-carousel' );

	wp_register_style( 'bootstrap-select', get_template_directory_uri() . '/assets/libraries/bootstrap-select/bootstrap-select.min.css' );
	...
	wp_register_script( 'bootstrap-select', get_template_directory_uri() . '/assets/libraries/bootstrap-select/bootstrap-select.min.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'bootstrap-select' );

	wp_register_script( 'bootstrap-dropdown', get_template_directory_uri() . '/assets/libraries/bootstrap-sass/javascripts/bootstrap/dropdown.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'bootstrap-dropdown' );

	wp_register_script( 'bootstrap-collapse', get_template_directory_uri() . '/assets/libraries/bootstrap-sass/javascripts/bootstrap/collapse.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'bootstrap-collapse' );

	wp_register_script( 'bootstrap-tooltip', get_template_directory_uri() . '/assets/libraries/bootstrap-sass/javascripts/bootstrap/tooltip.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'bootstrap-tooltip' );

	wp_register_script( 'bootstrap-alert', get_template_directory_uri() . '/assets/libraries/bootstrap-sass/javascripts/bootstrap/alert.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'bootstrap-alert' );

	wp_register_script( 'bootstrap-affix', get_template_directory_uri() . '/assets/libraries/bootstrap-sass/javascripts/bootstrap/affix.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'bootstrap-affix' );

	wp_register_script( 'bootstrap-tab', get_template_directory_uri() . '/assets/libraries/bootstrap-sass/javascripts/bootstrap/tab.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'bootstrap-tab' );

	wp_register_script( 'bootstrap-transition', get_template_directory_uri() . '/assets/libraries/bootstrap-sass/javascripts/bootstrap/transition.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'bootstrap-transition' );

	wp_register_script( 'bootstrap-scrollspy', get_template_directory_uri() . '/assets/libraries/bootstrap-sass/javascripts/bootstrap/scrollspy.js', array( 'jquery' ), false, true );
	...
	wp_register_script( 'scrollto', get_template_directory_uri() . '/assets/libraries/scrollto/jquery.scrollTo.min.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'scrollto' );

	wp_register_script( 'superlist', get_template_directory_uri() . '/assets/js/superlist.js', array( 'jquery' ), false, true );
...
function superlist_sidebars() {
	...
	register_sidebar( array( 'name' => __( 'Dashboard Sidebar Top', 'superlist' ), 'id' => 'dashboard-top', 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>' ) );
	register_sidebar( array( 'name' => __( 'Dashboard Sidebar Bottom', 'superlist' ), 'id' => 'dashboard-bottom', 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>' ) );
