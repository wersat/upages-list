				...
				<div class="widget widget_dashboard_navigation">
					...
					<ul>
						...
						<?php if ( ! empty( $create_listing_id ) ) : ?>
							<li><a href="<?php echo esc_attr( get_permalink( $create_listing_id ) ); ?>"><?php echo esc_attr( get_the_title( $create_listing_id ) ); ?></a></li>
						<?php endif; ?>

						<?php $submission_list_id = get_theme_mod( 'inventor_submission_list_page', false ); ?>
						<?php if ( ! empty( $submission_list_id ) ) : ?>
							<li><a href="<?php echo esc_attr( get_permalink( $submission_list_id ) ); ?>"><?php echo esc_attr( get_the_title( $submission_list_id ) ); ?></a></li>
						<?php endif; ?>

						<?php $favorites_id = get_theme_mod( 'inventor_favorites_page', false ); ?>
						<?php if ( ! empty( $favorites_id ) ) : ?>
							<li><a href="<?php echo esc_attr( get_permalink( $favorites_id ) ); ?>"><?php echo esc_attr( get_the_title( $favorites_id ) ); ?></a></li>
						<?php endif; ?>

						<?php $watchdogs_id = get_theme_mod( 'inventor_watchdogs_page', false ); ?>
						<?php if ( ! empty( $watchdogs_id ) ) : ?>
							<li><a href="<?php echo esc_attr( get_permalink( $watchdogs_id ) ); ?>"><?php echo esc_attr( get_the_title( $watchdogs_id ) ); ?></a></li>
						<?php endif; ?>

						<?php $invoices_id = get_theme_mod( 'inventor_invoices_page', false ); ?>
						<?php if ( ! empty( $invoices_id ) ) : ?>
							<li><a href="<?php echo esc_attr( get_permalink( $invoices_id ) ); ?>"><?php echo esc_attr( get_the_title( $invoices_id ) ); ?></a></li>
						<?php endif; ?>

						<?php $transactions_id = get_theme_mod( 'inventor_general_transactions_page', false ); ?>
						<?php if ( ! empty( $transactions_id ) ) : ?>
							<li><a href="<?php echo esc_attr( get_permalink( $transactions_id ) ); ?>"><?php echo esc_attr( get_the_title( $transactions_id ) ); ?></a></li>
						<?php endif; ?>

						<?php $profile_id = get_theme_mod( 'inventor_general_profile_page', false ); ?>
						<?php if ( ! empty( $profile_id ) ) : ?>
							<li><a href="<?php echo esc_attr( get_permalink( $profile_id ) ); ?>"><?php echo esc_attr( get_the_title( $profile_id ) ); ?></a></li>
						<?php endif; ?>

						<?php $change_password_id = get_theme_mod( 'inventor_general_password_page', false ); ?>
						<?php if ( ! empty( $change_password_id ) ) : ?>
							<li><a href="<?php echo esc_attr( get_permalink( $change_password_id ) ); ?>"><?php echo esc_attr( get_the_title( $change_password_id ) ); ?></a></li>
						<?php endif; ?>
					</ul>
				</div>
