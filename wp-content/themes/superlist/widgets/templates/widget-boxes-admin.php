...
<?php for ($i = 1; $i <= 3; $i++) : ?>
  ...
  <p>
    ...
    Add class in format <code>fa-[icon name]</code> (e.g. <code>fa-phone</code>).
    <br>
    See full icon list on
    <a href="<?php echo esc_url('http://fortawesome.github.io/Font-Awesome/icons/'); ?>">FontAwesome</a>
    .
  </p>
  <p>
